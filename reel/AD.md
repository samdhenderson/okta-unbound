...
A nineteen second cut for the Chrome Web Store listing. It is **not** part of
...
| Thing                   | Where                               | Notes                                                      |
| ----------------------- | ----------------------------------- | ---------------------------------------------------------- |
| The cut                 | `src/ad/script.ts`                  | Nine shots, their holds, and where the sound lands         |
...
`npm run ad:look -- --list`. Suggested read, about fifty words:

**hook** ~ "Every week, the same question. Six tabs later, you are still guessing."

**arrive** ~ "This opens beside the Okta tab you already have open."

**why** ~ "Every row says how it got there."

**compare** ~ "A rule reads a profile field. Hers was mistyped by one character."
...
**trust** ~ "No backend, no telemetry, nothing leaving your browser."

**end** ~ "Okta Unbound. Free, on the Chrome Web Store."

Narration for the ad does **not** go in `NARRATION.md` and is not measured by
`check-vo.mjs`: that gate is per film act and would report nine of these as
