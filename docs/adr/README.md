...
| [0019](./0019-motion-tokens-and-reduced-motion.md)                | Motion tokens and reduced motion                                                 | Accepted | Finite duration/easing scale + nine primitives; `prefers-reduced-motion` contract. |
| [0020](./0020-icon-rail-navigation.md)                            | Icon-rail navigation                                                             | Accepted | Third `Tabs` variant for the 8-tab strip; drawer considered and rejected.          |
