...
export function useSecurityAnalysis({ onProgress }: UseSecurityAnalysisOptions) {
      ...
      for (let i = 0; i < groupMembers.length; i++) {
        ...
        if (orphanReason) {
          orphanedAccounts.push({
            ...
            daysSinceLogin,
            neverLoggedIn,
            groupMemberships: 0, // Would need additional API call
            appAssignments: 0, // Would need additional API call
            orphanReason,
            riskLevel,
      ...
      for (let i = 0; i < groupMembers.length; i++) {
        ...
        if (shouldReview) {
          staleMemberships.push({
            ...
            addedDate: created,
            daysInGroup,
            source: 'direct', // Would need more analysis to determine
            lastAppUsage: null, // Would need app usage data
            shouldReview,
