...
import ContextBadge from './overview/shared/ContextBadge';
...
interface OverviewTabProps {
  onTabChange: (tab: 'rules' | 'users' | 'security' | 'groups' | 'apps' | 'history') => void;
}
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <ContextBadge pageType={pageType} entityName={entityName} />
          </div>
          <button
            onClick={refetch}
            disabled={isLoading}
