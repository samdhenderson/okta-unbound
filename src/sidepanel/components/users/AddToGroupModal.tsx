        ...
        */}
        <div className="relative">
          ...
          {showGroupDropdown && groupSearchResults.length > 0 && !selectedGroup && (
            <div className="absolute z-10 w-full mt-1 bg-white border border-neutral-200 rounded-md shadow-lg max-h-48 divide-y divide-neutral-100 overflow-y-auto">
              {groupSearchResults.map((group) => (
                ...
                >
                  ...
                  <div className="text-xs text-neutral-600">{group.type}</div>
                </button>
              ))}
            </div>
          )}
