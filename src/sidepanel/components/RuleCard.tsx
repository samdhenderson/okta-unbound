 ...
 *
 * This module owns the header and the expand/flash state only; the detail panel
 * handed to the `body` slot lives in {@link sidepanel/components/RuleCardDetails}.
 */
  ...
  ({
    ...
    return (
      <ListRow
        ...
        flash={isFlashing}
        body={
          // Handed to the `body` slot: inside the card's border, outside the
          // header's padding. It owns the `.disclose` wrapper the chevron's
