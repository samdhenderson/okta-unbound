      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-4 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          <select
            ...
            value={sortBy}
            onChange={(e) => setSortBy(e.target.value as 'email' | 'daysInGroup' | 'source')}
          >
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Added Date</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Days in Group</th>
              ...
              {sortedMemberships.map((membership) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">
                    {membership.addedDate ? membership.addedDate.toLocaleDateString() : (
                      <span className="text-gray-400 italic">Unknown</span>
                    )}
                  </td>
                  <td className="px-4 py-3 text-sm font-semibold text-gray-900">
                    {membership.daysInGroup ?? <span className="text-gray-400 font-normal">N/A</span>}
                  </td>
